$(function(){
    areaSelectMaker("select[name=addRegion]");
});
        ...
        (function(z){
            ...
            $(a1).on("change", function(){
                ...
                keys.forEach(function(Ci){
                    a2.append("<option value="+Ci+">"+Ci+"</option>");    
                });
            });
            ...
            $(a2).on("change", function(){
                ...
                var Region = a1.val();
                var Ci = $(this).val();
                var keys = Object.keys(area[Region][Ci]);
                keys.forEach(function(Gu){
                    a3.append("<option value="+area[Region][Ci][Gu]+">"+area[Region][Ci][Gu]+"</option>");    
                });
            });
        })(i);        
