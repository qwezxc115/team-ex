...
트리플 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 트리플  서비스의 이용과 관련하여 고집 서비스를 제공하는 트리플  주식회사(이하 ‘트리플 ’)와 이를 이용하는 트리플  서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 트리플 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
      				 </textarea>
                </li>
                <li class="checkBox check03">
                    ...
                    <textarea class="form-control" rows="4" readonly="readonly" >개인정보보호법에 따라 트리플에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 트리플 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 트리플은 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다
</textarea>
                </li>
                ...
                <li class="checkBox check03">
                    ...
                    <textarea class="form-control" rows="3" readonly="readonly" >위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 트리플 위치기반 서비스를 이용할 수 있습니다.
제 1 조 (목적)
이 약관은 트리플  주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
</textarea>
                </li>
