	...
	<div class="container">
		...
		<div class="container">
			<select class="form-select1" aria-label="Default select example">
				<option>카테고리</option>
				<option ${cri.cbcategory == 'f' ? 'selected' : '' } value="f">자유
				</option>
				<option ${cri.cbcategory == 't' ? 'selected' : '' } value="t">팁
				</option>
				<option ${cri.cbcategory == 'r' ? 'selected' : '' } value="r">후기
				</option>
			</select>

			<div id="write" class="d-flex ">
				<sec:authorize access="isAuthenticated()">
					<a class="nav-link btn btn-outline-secondary"
						href="${appRoot}/community/cbwriting">
						글쓰기
		...
		<div>
			...
			<div style="display: none;">
				<form id="actionForm" action="${appRoot }/community/cbhome"
					method="get">
