				...
				<div class="col-12">
					<form>
						<div class="form-group" style="display: none;">
							...
							<input readonly="readonly" id="nno" class="form-control"
								name="nno" value="${nvo.nno }">
						</div>

						<div class="form-group">
							<label for="input1">제목</label>
							<input readonly="readonly" id="input1" class="form-control"
								name="ntitle" value="${nvo.ntitle }">
						</div>

						<div class="form-group">
							<label for="textarea1">내용</label>
							<textarea readonly="readonly" id="textarea1" class="form-control"
								name="ndetail" rows="10"><c:out
									value="${nvo.ndetail }" /></textarea>
						</div>
