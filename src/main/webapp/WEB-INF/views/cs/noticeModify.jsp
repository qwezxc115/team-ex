...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12">
				<form id="modify-form" action="${appRoot }/cs/noticeModify"
					...
					<div class="form-group">
						...
						<input id="input1" class="form-control" name="ntitle"
							value="${nvo.ntitle }">
					</div>

					<div class="form-group">
						<label for="textarea1">내용</label>
						<textarea id="textarea1" class="form-control" name="ndetail"
							rows="30"><c:out value="${nvo.ndetail }" /></textarea>
					</div>
					...
					<div class="input-group justify-content-between">
						...
						<input id="cs_noticeDelete_btn" class="btn btn-danger"
