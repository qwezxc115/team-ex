						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach items="${jlist}" var="jmarket" varStatus="status">
									<tr>
										<td>
											<input type="checkbox" name="removeMnoList" value="${jmarket.mno }" class="mksct" 
											 form="removeAllForm2"/> ${status.count }
										</td>
							...
							<tbody>
								<c:forEach items="${rezlist1}" var="ebrezvo" varStatus="status">
									<tr>
										...
										<td>
											<a type="button" class="nav-link active p-0" data-toggle="modal" data-target="#rez-modal${status.count }">${ebrezvo.content}</a>
										</td>
								...
								<tbody>
									<c:forEach items="${rezlist}" var="ebrezvo" varStatus="status">
										<tr>
											...
											<td>
												<a type="button" class="nav-link active p-0" data-toggle="modal" data-target="#rez-modal${status.count }">
													${ebrezvo.content}
												</a>
											</td>
