		...
		<div class="row">
			<div class="col-3">
				<div class="nav flex-column nav-pills" id="v-pills-tab"
					...
					<a class="nav-link cl" id="v-pills-messages-tab" data-toggle="pill"
						href="#v-pills-messages" role="tab"
						aria-controls="v-pills-messages" aria-selected="false">내글관리 </a>
			...
			<div id="ch" class="col-9">
				...
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="jumbotron tab-pane fade" id="v-pills-messages"
						role="tabpanel" aria-labelledby="v-pills-messages-tab">
						<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link active" id="pills-home-tab"
									data-toggle="pill" href="#pills-cm" role="tab"
									aria-controls="pills-cm" aria-selected="true">자유게시판</a>
							</li>

							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-experts-tab" data-toggle="pill"
									href="#pills-experts" role="tab" aria-controls="pills-experts"
									aria-selected="false">숙소상담 </a>
							</li>
						</ul>
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade show active" id="pills-cm"
								role="tabpanel" aria-labelledby="pills-cm-tab">
								<div class="nav justify-content-end m-2">
									<form id="removeAllForm1" action="${appRoot }/mypage/removeAll"
										method="post">
										<button id="remove-cb" class="btn btn-outline-danger"
								...
								<table class="table table-hover">
									<thead>
										<tr>
											<th>
												<input type="checkbox" class="cbselectAll">
												#
											</th>
											<th>제목</th>
											<th>작성자</th>
											...
											<tr>
												<td>
													<input type="checkbox" name="removeBno"
														value="${cboard.bno }" class="cbsct" form="removeAllForm1" />
													${status.count }
												</td>
												...
												<td>
													<fmt:formatDate pattern="yyyy-MM-dd"
														value="${cboard.regdate }" />
												</td>

												<td>
													<fmt:formatDate pattern="yyyy-MM-dd"
														value="${cboard.updateDate }" />
												</td>
											</tr>
										</c:forEach>
									</tbody>
							...
							<script type="text/javascript">
								var selectAll = document
										.querySelector(".cbselectAll");
								selectAll.addEventListener('click', function() {
									var objs = document
											.querySelectorAll(".cbsct");
							...
							<script type="text/javascript">
								var mkselectAll = document
										.querySelector(".mkselectAll");
								mkselectAll
										.addEventListener(
												'click',
												function() {
													var objs2 = document
															.querySelectorAll(".mksct");
							...
							<div class="tab-pane fade show" id="pills-experts"
								role="tabpanel" aria-labelledby="pills-experts-tab">
								<div class="nav justify-content-end m-2">
									<form id="removeAllForm3"
										action="${appRoot }/mypage/removerezmsgAll" method="post">
										<button id="remove-rez" class="btn btn-outline-info"
											type="submit">삭제</button>
									</form>
								</div>
								<sec:authorize access="hasRole('ROLE_USER')">
									<table class="table table-hover">
										...
										<tbody>
											<c:forEach items="${rezlist1}" var="ebrezvo"
												varStatus="status">
												<tr>
													<td>
													...
													<td>
														<a type="button" class="nav-link active p-0"
															data-toggle="modal"
															data-target="#rez-modal${status.count }">${ebrezvo.content}</a>
													</td>
												...
												<!-- 상담 내역 확인   -->
												<div class="modal fade" id="rez-modal${status.count }"
													aria-labelledby="exampleModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title">인테리어 예약 내역</h5>
															...
															<div class="modal-body">
																<div class="card-body">
																	...
																	<input value="${ebrezvo.readerName }" readonly
																		class="form-control" />
																</div>
																<div class="card-body">
																	<label class="mt-1 mb-1" for="rezdate">예약날짜 </label>
																	<input type="date" readonly
																		class="form-control mt-1 mb-1" name="rezdate"
																		id="rezdate" value="${ebrezvo.rezdate }" />
																</div>
																<div class="card-body">
																	<label class="mt-1 mb-1" for="rezdate">시간</label>
																	<input type="time" readonly
																		class="form-control mt-1 mb-1" name="reztime"
																		id="reztime" value="${ebrezvo.reztime }" />
																</div>
																<hr>
																<div class="card-body">
																	예약 내용
																	<textarea id="title-textarea" readonly
																		class="form-control card-text" name="content" rows="4"><c:out
																			value="${ebrezvo.content}" /></textarea>
																</div>
																<div class="card-body">
																	<label for="input2">작성자</label>
																	<input id="input2" type="hidden"
																		value="${pinfo.user.userid }" readonly
																		class="form-control" name="writer">
																	<input value="${pinfo.user.userName }" readonly
																		class="form-control">
																</div>
															</div>
								...
								<sec:authorize access="hasRole('ROLE_BUSINESS')">
									<table class="table table-hover">
										...
										<tbody>
											<c:forEach items="${rezlist}" var="ebrezvo"
												varStatus="status">
												<tr>
													<td>
														<input type="checkbox" name="removeRnoList"
													...
													<td>
														<a type="button" class="nav-link active p-0"
															data-toggle="modal"
															data-target="#rez-modal${status.count }">
															${ebrezvo.content} </a>
													</td>
												...
												<div class="modal fade" id="rez-modal${status.count }"
													...
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title">상담예약 신청 내역</h5>
																<button type="button" class="close" data-dismiss="modal">
																	<span>&times;</span>
																</button>
															</div>
															<div class="modal-body">
																<div class="card-body">
																	...
																	<input value="${ebrezvo.writerName }" readonly
																		class="form-control" />
																</div>
																<div class="card-body">
																	<label for="input2">업체 </label>
							...
							<script type="text/javascript">
								var rezselectAll = document
										.querySelector(".rezselectAll");
								rezselectAll
										.addEventListener(
												'click',
												function() {
													var obrez = document
															.querySelectorAll(".rezsct");
